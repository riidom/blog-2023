...
Once this is sorted out (or you just created your own content and used demo stuff just for reference):
...
In `post/`, create a sub-directory with the post's date in `yymmdd` format. Inside, there needs to be:
